...
use Exception;
use Lego\Console\ComponentsFeature;
...
class Parser
{
    ...
    public const SYNTAX_STRING = 'string';

    public const SYNTAX_KEYWORD = 'keyword';

    public const SYNTAX_INSTANTIATION = 'init';
     ...
     * @throws Exception
     */
    public function parseJobInLine(string $line, string $contents): Job|string
    {
        $line = trim($line);
